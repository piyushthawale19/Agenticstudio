import AgentPulse from "@/components/AgentPluse";
import YoutubeVideoForm from "@/components/YoutubeVideoForm";
import { Brain, DownloadCloudIcon, Facebook, Github, ImageIcon, Linkedin, MessageSquare, Sparkles, Video } from "lucide-react";
...
export default function Home() {
  ...
  return (
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold text-center mb-12">
            Supercharged AI Tools for Modern Creators
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-600 to-blue-400 rounded-full flex items-center justify-center mb-4 mx-auto">
      ...
      {/* Footer Section */}
      <section className="py-20 px-4 md:px-0 bg-gradient-to-r from-purple-600 to-blue-400">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            Ready to Elevate Your AI Content Creation?
          </h2>
          <p className="text-xl text-blue-50">
            Join Agentic Studio today and transform your video content with the power of AI.
          </p>
          <div className="text-center pt-10 flex justify-center gap-10">
             <Link href="https://github.com/piyushthawale19" target="_blank" >
               <Github className="w-6 h-6 text-white cursor-pointer mx-auto" />
             </Link>
             <Link href="https://www.linkedin.com/in/piyush-thawale-03b706259/" target="_blank" >
               <Linkedin className="w-6 h-6 text-white cursor-pointer mx-auto" />
             </Link>
             <Link href="https://www.facebook.com/piyush.thawale.94" target="_blank" >
               <Facebook className="w-6 h-6 text-white cursor-pointer mx-auto" />
             </Link>
             <Link href="https://drive.google.com/file/d/1jxEoBKDA5XLRKNKGJb7BV_xcXoruZm97/view?usp=sharing" target="_blank" >
               <DownloadCloudIcon className="w-6 h-6 text-white cursor-pointer mx-auto" />
             </Link>
          </div >
        </div>
      </section>
