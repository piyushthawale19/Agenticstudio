  ...
  if (!video)
    return (
      <div className="flex items-center justify-center  p-4">
        <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-gray-300 border-t-blue-500"></div>
      </div>
    );
        ...
        <div className="flex-grow space-y-4">
          ...
          <div className="flex items-center gap-4">
            <Image
              ...
              width={48}
              height={48}
              className="rounded-full w-10 h-10 @md:w-12 @md:h-12 border-2 border-gray-100"
            />
            <div>
              <p className="font-semibold text-base text-gray-900 @md:text-lg">
                {video.channel.title}
              </p>
